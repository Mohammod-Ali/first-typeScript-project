...
export const StudentValidationSchema = z.object({
  ...
  gender: z.string().enum(['male', 'female', 'other']).message('Gender is not valid'),
  dateOfBirth: z.string().optional(),
  email: z.string().min(1, { message: 'Email is required' }).email({ message: 'Email is not a valid email' }),
